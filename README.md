...
Looking back at our journey, this comic strip offers a visual reflection of the project’s wider aims and the path taken to reach them. It shows how generative AI can be used not just to produce images, but to help translate research into a form that feels inviting, accessible, and engaging for a general audience.

At the same time, the strip also reminds us that AI output is only one part of the process. The meaning of the work still depends on human interpretation, critical framing, and the historical context that shapes every image and idea. In this sense, the final outcome is less about replacing the archive than about opening a space for conversation around what has been preserved, what has been lost, and what might still be reimagined. 
